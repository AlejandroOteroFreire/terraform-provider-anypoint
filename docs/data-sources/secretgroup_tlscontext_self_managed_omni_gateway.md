...
page_title: "anypoint_secretgroup_tlscontext_self_managed_omni_gateway Data Source - terraform-provider-anypoint"
subcategory: ""
description: |-
  Query a specific tls-context of type "SelfManagedOmniGateway" for a secret-group in a given organization and environment.
---

# anypoint_secretgroup_tlscontext_self_managed_omni_gateway (Data Source)
...
```terraform
data "anypoint_secretgroup_tlscontext_self_managed_omni_gateway" "fg" {
  id     = var.id
