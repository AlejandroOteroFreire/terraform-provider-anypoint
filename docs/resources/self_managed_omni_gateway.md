...
page_title: "anypoint_self_managed_omni_gateway Resource - terraform-provider-anypoint"
subcategory: ""
description: |-
  Create an API Manager Instance of type Self-Managed Omni Gateway.
...
# anypoint_self_managed_omni_gateway (Resource)
...
resource "anypoint_self_managed_omni_gateway" "fg" {
  ...
  deployment_type = "HY"
  instance_label  = "my terraform omni gateway instance"
...
- `deployment_target_id` (String) The instance's deployment Self-Managed Omni Gateway target id
- `deployment_target_name` (String) The instance's deployment Self-Managed Omni Gateway target name
- `env_id` (String) The environment id where the Self-Managed Omni Gateway instance is defined.
- `org_id` (String) The organization id where the Self-Managed Omni Gateway instance is defined.
...
- `id` (String) The API Manager Self-Managed Omni Gateway instance id.
...
- `technology` (String) The type of API Manager instance. Always equals to `flexGateway` — the Anypoint API still uses the legacy identifier for Self-Managed Omni Gateway instances.
