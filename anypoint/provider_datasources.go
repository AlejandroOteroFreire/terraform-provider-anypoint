...
var DATASOURCES_MAP = map[string]*schema.Resource{
	...
	"anypoint_self_managed_omni_gateway_target":             dataSourceSelfManagedOmniGatewayTarget(),
	"anypoint_self_managed_omni_gateway_targets":            dataSourceSelfManagedOmniGatewayTargets(),
	"anypoint_self_managed_omni_gateway_registration_token": dataSourceSelfManagedOmniGatewayRegistrationToken(),
	...
	"anypoint_secretgroup_tlscontext_self_managed_omni_gateway": dataSourceSecretGroupTlsContextFG(),
	...
	"anypoint_private_space_connections":             dataSourcePrivateSpaceConnections(),
	"anypoint_private_space_connection":              dataSourcePrivateSpaceConnection(),
