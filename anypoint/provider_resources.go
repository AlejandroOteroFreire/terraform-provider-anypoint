...
var RESOURCES_MAP = map[string]*schema.Resource{
	...
	"anypoint_self_managed_omni_gateway":             resourceApimSelfManagedOmniGateway(),
	...
	"anypoint_secretgroup_tlscontext_self_managed_omni_gateway": resourceSecretGroupTlsContextFG(),
	...
	"anypoint_private_space_connection":              resourcePrivateSpaceConnection(),
	"anypoint_private_space_transit_gateway":          resourcePrivateSpaceTransitGateway(),
	"anypoint_private_space_association":              resourcePrivateSpaceAssociation(),
	"anypoint_private_space_advanced_config":          resourcePrivateSpaceAdvancedConfig(),
	"anypoint_private_space_upgrade":                  resourcePrivateSpaceUpgrade(),
	"anypoint_managed_omni_gateway":                   resourceManagedOmniGateway(),
	"anypoint_agent_instance":                         resourceAgentInstance(),
	"anypoint_mcp_server":                             resourceMCPServer(),
	"anypoint_connected_app_scopes":                   resourceConnectedAppScopes(),
	"anypoint_apim_sla_tier":                          resourceApimSlaTier(),
	"anypoint_secretgroup_sharedsecret":               resourceSecretGroupSharedSecret(),
	"anypoint_secretgroup_certificatepinset":          resourceSecretGroupCertificatePinset(),
}
