...
// ─── SLA Tier API Methods ──────────────────────────────────────────────────

type DefaultApiCreateSlaTierRequest struct {
	ctx       context.Context
	ApiService *DefaultApiService
	orgId     string
	envId     string
...
func (r DefaultApiCreateSlaTierRequest) SlaTierBody(body SlaTier) DefaultApiCreateSlaTierRequest {
	r.body = &body
	return r
}

func (r DefaultApiCreateSlaTierRequest) Execute() (*SlaTier, *http.Response, error) {
	return r.ApiService.CreateSlaTierExecute(r)
}

func (a *DefaultApiService) CreateSlaTier(ctx context.Context, orgId, envId, apiId string) DefaultApiCreateSlaTierRequest {
	return DefaultApiCreateSlaTierRequest{ApiService: a, ctx: ctx, orgId: orgId, envId: envId, apiId: apiId}
}

func (a *DefaultApiService) CreateSlaTierExecute(r DefaultApiCreateSlaTierRequest) (*SlaTier, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.CreateSlaTier")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	localVarPath := localBasePath + "/organizations/{orgId}/environments/{envId}/apis/{apiId}/tiers"
	...
	localVarPath = strings.Replace(localVarPath, "{"+"apiId"+"}", url.PathEscape(parameterValueToString(r.apiId, "")), -1)
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	localVarHTTPContentTypes := []string{"application/json"}
...
type DefaultApiGetSlaTiersRequest struct {
	ctx       context.Context
	ApiService *DefaultApiService
	orgId     string
	envId     string
...
func (r DefaultApiGetSlaTiersRequest) Execute() (*SlaTierListResponse, *http.Response, error) {
	return r.ApiService.GetSlaTiersExecute(r)
}

func (a *DefaultApiService) GetSlaTiers(ctx context.Context, orgId, envId, apiId string) DefaultApiGetSlaTiersRequest {
	return DefaultApiGetSlaTiersRequest{ApiService: a, ctx: ctx, orgId: orgId, envId: envId, apiId: apiId}
}

func (a *DefaultApiService) GetSlaTiersExecute(r DefaultApiGetSlaTiersRequest) (*SlaTierListResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SlaTierListResponse
	)
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetSlaTiers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	localVarPath := localBasePath + "/organizations/{orgId}/environments/{envId}/apis/{apiId}/tiers"
...
type DefaultApiUpdateSlaTierRequest struct {
	ctx       context.Context
	ApiService *DefaultApiService
	orgId     string
	envId     string
...
func (r DefaultApiUpdateSlaTierRequest) SlaTierBody(body SlaTier) DefaultApiUpdateSlaTierRequest {
	r.body = &body
	return r
}

func (r DefaultApiUpdateSlaTierRequest) Execute() (*SlaTier, *http.Response, error) {
	return r.ApiService.UpdateSlaTierExecute(r)
}

func (a *DefaultApiService) UpdateSlaTier(ctx context.Context, orgId, envId, apiId, tierId string) DefaultApiUpdateSlaTierRequest {
	return DefaultApiUpdateSlaTierRequest{ApiService: a, ctx: ctx, orgId: orgId, envId: envId, apiId: apiId, tierId: tierId}
}

func (a *DefaultApiService) UpdateSlaTierExecute(r DefaultApiUpdateSlaTierRequest) (*SlaTier, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.UpdateSlaTier")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	localVarPath := localBasePath + "/organizations/{orgId}/environments/{envId}/apis/{apiId}/tiers/{tierId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgId"+"}", url.PathEscape(parameterValueToString(r.orgId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"envId"+"}", url.PathEscape(parameterValueToString(r.envId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"apiId"+"}", url.PathEscape(parameterValueToString(r.apiId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tierId"+"}", url.PathEscape(parameterValueToString(r.tierId, "")), -1)
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	localVarHTTPContentTypes := []string{"application/json"}
...
type DefaultApiDeleteSlaTierRequest struct {
	ctx       context.Context
	ApiService *DefaultApiService
	orgId     string
	envId     string
...
func (r DefaultApiDeleteSlaTierRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSlaTierExecute(r)
}

func (a *DefaultApiService) DeleteSlaTier(ctx context.Context, orgId, envId, apiId, tierId string) DefaultApiDeleteSlaTierRequest {
	return DefaultApiDeleteSlaTierRequest{ApiService: a, ctx: ctx, orgId: orgId, envId: envId, apiId: apiId, tierId: tierId}
}

func (a *DefaultApiService) DeleteSlaTierExecute(r DefaultApiDeleteSlaTierRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	)
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.DeleteSlaTier")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
	localVarPath := localBasePath + "/organizations/{orgId}/environments/{envId}/apis/{apiId}/tiers/{tierId}"
